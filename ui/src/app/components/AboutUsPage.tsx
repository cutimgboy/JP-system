  ...
  return (
    <div className="bg-black relative size-full flex items-center justify-center">
      <div className="absolute bg-[#09090b] border-[#1f1f22] border-[3.899px] border-solid h-[853.07px] left-0 md:left-auto overflow-clip rounded-[40px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] top-0 md:top-auto w-[393.005px] flex flex-col relative text-white">
        ...
        {/* Header */}
        <div className="h-[60px] flex items-center justify-between px-6 shrink-0 relative z-20 bg-[#09090b]/80 backdrop-blur-md border-b border-white/5 pt-12 pb-4 box-content">
          <button 
            onClick={() => navigate(-1)}
          ...
          <h1 className="font-['Inter:Medium'] text-[16px] font-medium tracking-wide">关于我们</h1>
          <div className="w-10" />
        </div>

        <div className="flex-1 overflow-y-auto pb-10" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
