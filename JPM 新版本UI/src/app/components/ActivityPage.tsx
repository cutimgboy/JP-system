...
export function ActivityPage() {
  ...
  return (
    <div className="bg-black relative size-full flex items-center justify-center">
      <div className="absolute bg-[#09090b] border-[#1f1f22] border-[3.899px] border-solid h-[853.07px] left-0 md:left-auto overflow-clip rounded-[40px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] top-0 md:top-auto w-[393.005px] flex flex-col relative text-white">
        
        {/* Header */}
        <div className="h-[60px] flex items-center justify-between px-6 shrink-0 relative z-20 bg-[#09090b]/80 backdrop-blur-md border-b border-white/5">
          <button 
            onClick={() => navigate(-1)}
          ...
          <h1 className="font-['Inter:Medium'] text-[16px] font-medium tracking-wide">活动详情</h1>
          <div className="w-10" />
        </div>
        ...
        {/* Bottom Fixed CTA */}
        <div className="absolute bottom-0 left-0 w-full p-6 pt-4 bg-gradient-to-t from-[#09090b] via-[#09090b]/90 to-transparent z-30">
          <button className="w-full h-[54px] bg-[#6c48f5] hover:bg-[#5a3ae0] transition-colors rounded-[20px] font-['Inter:Semi_Bold'] font-semibold text-[16px] text-white shadow-[0px_8px_20px_rgba(108,72,245,0.3)] flex items-center justify-center gap-2">
            立即入金参与
